      ...
      <header className="bg-white border-b">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Add New Piece</h1>
          </div>
        </div>
      </header>

      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form action={createPiece} className="bg-white rounded-lg border p-6 space-y-4">
          <div>
          ...
          <div>
            ...
            <input
              ...
              name="tags"
              className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="e.g., romantic,nocturne (comma-separated)"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              name="links"
              className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="e.g., IMSLP or YouTube link"
            />
          </div>
